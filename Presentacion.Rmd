...
```{r echo=FALSE, seguros, fig.align = 'center', out.width = "45%"}
knitr::include_graphics(here::here("images", "03_seguros.png"))
```

```{r echo=FALSE, encuestas, fig.align = 'center', out.width = "70%"}
knitr::include_graphics(here::here("images", "03_encuestas.png"))
```

```{r echo=FALSE, finanzas, fig.align = 'center', out.width = "50%"}
knitr::include_graphics(here::here("images", "03_finanzas.png"))
```

```{r echo=FALSE, academia, fig.align = 'center', out.width = "50%"}
knitr::include_graphics(here::here("images", "03_academia.png"))
```

</div>

```{r echo=FALSE, gobierno, fig.align = 'center', out.width = "23%"}
knitr::include_graphics(here::here("images", "03_gobierno.png"))
```
...
```{r echo=FALSE, mapa_01, fig.align = 'center', out.width = "60%"}
...
<div class="columns-2">
```{r echo=FALSE, cel_01, fig.align = 'center', out.width = "90%"}
knitr::include_graphics(here::here("images", "10_cel.png"))
```

```{r echo=FALSE, qr_01, fig.align = 'center', out.width = "65%"}
knitr::include_graphics(here::here("images", "10_qr.png"))
```
</div>

## Encuestas trimestrales – actividad

<div style='position: relative; padding-bottom: 48%; padding-top: 35px; height: 0; overflow: hidden;'><iframe sandbox='allow-scripts allow-same-origin allow-presentation' allowfullscreen='true' allowtransparency='true' frameborder='0' height='315' src='https://www.mentimeter.com/app/presentation/alzhahvfrtqnns8v5gb5p44gwveshxaa/embed' style='position: absolute; top: 0; left: 0; width: 100%; height: 100%;' width='420'></iframe></div>
...
```{r echo=FALSE, sie, fig.align = 'center', out.width = "15%"}
knitr::include_graphics(here::here("images", "14_sie.png"))
```
</div>
...
- **Billete**
   ...
   - Porcentaje de personas que recuerdan o conocen 2 o más elementos de seguridad
...
- Evaluación general de los Bocentos
...
<div class="columns-2">
```{r echo=FALSE, cel_02, fig.align = 'center', out.width = "90%"}
knitr::include_graphics(here::here("images", "10_cel.png"))
```

```{r echo=FALSE, qr_02, fig.align = 'center', out.width = "65%"}
knitr::include_graphics(here::here("images", "16_qr.png"))
```
</div>

## Encuesta anual – actividad

<div style='position: relative; padding-bottom: 48%; padding-top: 35px; height: 0; overflow: hidden;'><iframe sandbox='allow-scripts allow-same-origin allow-presentation' allowfullscreen='true' allowtransparency='true' frameborder='0' height='315' src='https://www.mentimeter.com/app/presentation/al4p81oqr4ot53xhpuhtooas1t3r9jha/embed' style='position: absolute; top: 0; left: 0; width: 100%; height: 100%;' width='420'></iframe></div>
...
```{r echo=FALSE, plots_a, fig.align = 'center', out.width = "120%"}
knitr::include_graphics(here::here("images", "18_plots_a.png"))
```

```{r echo=FALSE, billete_a, fig.align = 'center', out.width = "45%"}
knitr::include_graphics(here::here("images", "18_billete_a.png"))
```
</div>
...
- **71 % conoce** el billete
- Sólo el **20 %** de quienes lo conocen, **saben** que el personaje es **Sor Juana Inés de la Cruz**.

```{r echo=FALSE, plots_b, fig.align = 'center', out.width = "120%"}
knitr::include_graphics(here::here("images", "19_plots_b.png"))
```

```{r echo=FALSE, billete_b, fig.align = 'center', out.width = "45%"}
knitr::include_graphics(here::here("images", "19_billete_b.png"))
```
</div>
...
```{r echo=FALSE, mapa_02, fig.align = 'center', out.width = "35%"}
...
- Relieve en ventana transaparente de los billetes
...
```{r echo=FALSE, diagrama, fig.align = 'center', out.width = "90%"}
knitr::include_graphics(here::here("images", "34_diagrama.png"))
```

```{r echo=FALSE, marcas_mexico, fig.align = 'center', out.width = "50%"}
...
<div class="columns-2">
```{r echo=FALSE, atm_2, fig.align = 'center', out.width = "100%"}
knitr::include_graphics(here::here("images", "39_atm.png"))
```

```{r echo=FALSE, canje_01, fig.align = 'right', out.width = "88%"}
knitr::include_graphics(here::here("images", "39_canje.png"))
```
</div>
...
```{r echo=FALSE, deteriorado, fig.align = 'center', out.width = "65%"}
knitr::include_graphics(here::here("images", "40_deteriorado.png"))
```

```{r echo=FALSE, desmonetizado, fig.align = 'center', out.width = "65%"}
knitr::include_graphics(here::here("images", "40_desmonetizado.png"))
```

```{r echo=FALSE, canje_02, fig.align = 'center', out.width = "65%"}
...
- Uso de técnicas que integran Neurociencia<footnote>Técnica científica que estudia el sistema nervioso del ser humano para trata de descifrar cómo opera el cerebro.</footnote>, Antropología, Psicología, Estadística y Tecnológia
   - Laboratorio
   - Entrevistas
...
<div class="columns-2">
```{r echo=FALSE, zonas_20, fig.align = 'center', out.width = "70%"}
knitr::include_graphics(here::here("images", "48_20.png"))
```

```{r echo=FALSE, zonas_200, fig.align = 'center', out.width = "80%"}
knitr::include_graphics(here::here("images", "48_200.png"))
```
</div>
...
```{r echo=FALSE, memorables, fig.align = 'center', out.width = "60%"}
...
```{r echo=FALSE, navegacion, fig.align = 'center', out.width = "80%"}
...
```{r echo=FALSE, marca_200, fig.align = 'center', out.width = "65%"}
...
## Comentarios finales
Características de un **actuario**:
...
- **Ponente**: Víctor H. Cuspinera Contreras
   ...
   - ![](images/54_email.png){width=4%} [vcuspinera@gmail.com](mailto:vcuspinera@gmail.com)
   - ![](images/54_linkedin.png){width=4%} [victor-cuspinera-56185a28](https://www.linkedin.com/in/victor-cuspinera-56185a28/)
   - ![](images/54_github.png){width=4%} [vcuspinera](https://github.com/vcuspinera)

<br>

- **Centro de contacto**: información de billetes y monedas

   - ![](images/54_tel.png){width=3%} 800-BANXICO (800 226 9426)
   - ![](images/54_email.png){width=4%} [dinero@banxico.org.mx](mailto:dinero@banxico.org.mx)
